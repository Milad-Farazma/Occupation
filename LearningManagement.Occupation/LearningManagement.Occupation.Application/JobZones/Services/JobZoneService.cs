...
public class JobZoneService(IJobZoneRepository repo, IUserService userService) : IJobZoneService {
    ...
    public async Task<JobZoneDto> GetByIdAsync(Guid id, bool loadRelations, CancellationToken cancellationToken = default) {
    ...
    public async Task UpdateAsync(Guid id, UpdateJobZoneRequest request, CancellationToken cancellationToken = default) {
