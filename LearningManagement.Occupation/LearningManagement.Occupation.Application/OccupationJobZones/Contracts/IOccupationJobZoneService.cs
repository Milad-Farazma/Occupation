...
public interface IOccupationJobZoneService {
    ...
    Task<OccupationJobZoneDto> GetByIdAsync(long id, bool loadRelations, CancellationToken cancellationToken = default);
    Task UpdateAsync(long id, UpdateOccupationJobZoneRequest request, CancellationToken cancellationToken = default);
