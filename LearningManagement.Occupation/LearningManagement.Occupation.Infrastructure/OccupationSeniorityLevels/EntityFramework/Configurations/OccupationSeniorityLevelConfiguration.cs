...
namespace LearningManagement.Occupation.Infrastructure.OccupationSeniorityLevels.EntityFramework.Configurations;

public class OccupationSeniorityLevelConfiguration : IEntityTypeConfiguration<OccupationSeniorityLevel> {
    public void Configure(EntityTypeBuilder<OccupationSeniorityLevel> builder) {
        ...
        builder.HasOne(d => d.SeniorityLevel)
            .WithMany(p => p.OccupationSeniorityLevels)
            .HasForeignKey(d => d.SeniorityLevelId)
            .OnDelete(DeleteBehavior.ClientSetNull);

        builder.HasOne(d => d.Occupation).WithMany(p => p.OccupationSeniorityLevels)
