...
namespace LearningManagement.Occupation.Infrastructure.JobZones.EntityFramework.Configurations;

public class JobZoneConfiguration : IEntityTypeConfiguration<JobZone> {
    public void Configure(EntityTypeBuilder<JobZone> builder) {
        builder.ToTable("JobZones");
        ...
        builder.HasMany(entity => entity.OccupationJobZons)
            .WithOne(entity => entity.JobZone)
            .HasForeignKey(entity => entity.JobZoneId)
            .IsRequired();
