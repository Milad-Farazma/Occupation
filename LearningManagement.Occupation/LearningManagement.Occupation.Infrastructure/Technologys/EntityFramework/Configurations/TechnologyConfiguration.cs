...
namespace LearningManagement.Occupation.Infrastructure.Technologys.EntityFramework.Configurations;
...
public class TechnologyConfiguration : IEntityTypeConfiguration<Technology> {
    public void Configure(EntityTypeBuilder<Technology> builder) {
        ...
        builder.HasOne(d => d.TechnologyType).WithMany(p => p.Technologies)
