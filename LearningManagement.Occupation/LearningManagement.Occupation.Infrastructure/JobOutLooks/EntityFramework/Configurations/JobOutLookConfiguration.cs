...
namespace LearningManagement.Occupation.Infrastructure.JobOutLooks.EntityFramework.Configurations;

public class JobOutLookConfiguration : IEntityTypeConfiguration<JobOutLook> {
    public void Configure(EntityTypeBuilder<JobOutLook> builder) {
        ...
        builder.Property(e => e.IconTitle).HasMaxLength(50);
        builder.Property(e => e.Title).HasMaxLength(50);

        #region Relations

        builder.HasMany(entity => entity.Occupations)
            .WithOne(entity => entity.JobOutlook)
