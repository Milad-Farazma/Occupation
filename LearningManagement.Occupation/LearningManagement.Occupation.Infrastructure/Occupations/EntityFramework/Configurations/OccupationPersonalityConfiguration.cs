...
public class OccupationPersonalityConfiguration : IEntityTypeConfiguration<OccupationPersonality> {
    public void Configure(EntityTypeBuilder<OccupationPersonality> builder) {
