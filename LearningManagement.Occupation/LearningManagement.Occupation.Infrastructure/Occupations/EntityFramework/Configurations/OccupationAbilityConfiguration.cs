...
public class OccupationAbilityConfiguration : IEntityTypeConfiguration<OccupationAbility> {
    public void Configure(EntityTypeBuilder<OccupationAbility> builder) {
