...
public class OccupationKnowledgeConfiguration : IEntityTypeConfiguration<OccupationKnowledge> {
    public void Configure(EntityTypeBuilder<OccupationKnowledge> builder) {
