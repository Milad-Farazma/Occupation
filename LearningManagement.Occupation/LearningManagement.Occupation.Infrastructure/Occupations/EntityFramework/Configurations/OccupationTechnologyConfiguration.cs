...
public class OccupationTechnologyConfiguration : IEntityTypeConfiguration<OccupationTechnology> {
    public void Configure(EntityTypeBuilder<OccupationTechnology> builder) {
