...
using LearningManagement.Occupation.Infrastructure.JobZones.Repositories;
...
using LearningManagement.Occupation.Infrastructure.OccupationJobZones.Repositories;
using LearningManagement.Occupation.Infrastructure.OccupationSimilaritys.Repositories;
...
public static class InfrastructureServiceRegistration {
    ...
    private static void AddRepositories(IServiceCollection services) {
        ...
        services.AddScoped<IJobZoneRepository, JobZoneRepository>();
        services.AddScoped<IKnowledgeRepository, KnowledgeRepository>();
        services.AddScoped<IKnowledgeTypeRepository, KnowledgeTypeRepository>();
        services.AddScoped<IOccupationJobZoneRepository, OccupationJobZoneRepository>();
