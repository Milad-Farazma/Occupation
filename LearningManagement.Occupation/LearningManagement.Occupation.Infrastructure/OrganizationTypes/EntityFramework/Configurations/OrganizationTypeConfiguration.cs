...
namespace LearningManagement.Occupation.Infrastructure.OrganizationTypes.EntityFramework.Configurations;
...
public class OrganizationTypeConfiguration : IEntityTypeConfiguration<OrganizationType> {
    public void Configure(EntityTypeBuilder<OrganizationType> builder) {
        ...
        builder.HasMany(entity => entity.Organizations)
            .WithOne(entity => entity.OrganizationType)
            .HasForeignKey(entity => entity.OrganizationTypeId)
            .IsRequired();
